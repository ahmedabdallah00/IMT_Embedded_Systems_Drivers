...
void LCD_Set_Cursor_Pose(u8 line_num ,u8 line_pose)
{
	switch(line_num)
	{
	case 0:
		LCD_SendCommand(0b10000000+line_pose%16);
		break;
	case 1:
		LCD_SendCommand(0b10000000+line_pose%16+64);
			break;
